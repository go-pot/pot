// Code generated by "pkgimport -p pot -i github.com/wzshiming/ffmt -o ffmt.go"; DO NOT EDIT.

//go:generate pkgimport -p pot -i github.com/wzshiming/ffmt -o ffmt.go

package pot

import (
	origin "github.com/wzshiming/ffmt"
)
